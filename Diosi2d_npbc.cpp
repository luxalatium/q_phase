                        ...
                        for (int i2 = x2_min; i2 <= x2_max; i2 ++)  {
                            if (TAMask[i1*W1+i2])  {
                                ...
                                KK1[i1*W1+i2] = -kh0m * xx2 * (-f1p2/12.0 + 2/3.0*f1p1 - 2/3.0*f1m1 + f1m2/12.0) + 
                                              ...
                                              - khbsq2h1 * quantumness * POTENTIAL_XXX(xx1, xx2) * (0.5*f2p2 - f2p1 + f2m1 - 0.5*f2m2) +
                        ...
                        for (int i2 = x2_min; i2 <= x2_max; i2 ++)  {
                            if (TAMask[i1*W1+i2])  {
                                ...
                                KK2[i1*W1+i2] = -kh0m * xx2 * (-1/12.0*(f1p2+0.5*kk1p2) + 2/3.0*(f1p1+0.5*kk1p1) - 2/3.0*(f1m1+0.5*kk1m1) + 1/12.0*(f1m2+0.5*kk1m2)) + 
                                            ...
                                            khbsq2h1 * quantumness * POTENTIAL_XXX(xx1, xx2) * (0.5*(f2p2+0.5*kk2p2) - (f2p1+0.5*kk2p1) + (f2m1+0.5*kk2m1) - 0.5*(f2m2+0.5*kk2m2)) +
                        ...
                        for (int i2 = x2_min; i2 <= x2_max; i2 ++)  {
                            if (TAMask[i1*W1+i2])  {
                                ...
                                KK4[i1*W1+i2] = -kh0m * xx2 * (-1/12.0*(f1p2+kk1p2) + 2/3.0*(f1p1+kk1p1) - 2/3.0*(f1m1+kk1m1) + 1/12.0*(f1m2+kk1m2)) + 
                                            ...
                                            khbsq2h1 * quantumness * POTENTIAL_XXX(xx1, xx2) * (0.5*(f2p2+kk2p2) - (f2p1+kk2p1) + (f2m1+kk2m1) - 0.5*(f2m2+kk2m2)) + 
