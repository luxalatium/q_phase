// ==============================================================================
//
//  WignerMoyal4dFull.cpp
//  QTR
//
//  Created by Albert Lu on 1/16/20.
//  alu@tacc.utexas.edu
//
...
void WignerMoyal4d::Evolve()
{
    ...
    log->log("[WignerMoyal4d] Fine grid size = (");
    ...
    t_1_end = omp_get_wtime();
    t_1_elapsed = t_1_end - t_1_begin;
    if (!QUIET && TIMING) log->log("[WignerMoyal4d] Elapsed time (Wavefunction normalization) = %lf sec\n\n", t_1_elapsed); 
    ...
    for (unsigned long int tt = 0; tt < (unsigned long int)(TIME / kk); tt ++)
    {
        ...
        {   
            ...
            if ( !QUIET )  {
                ...
                log->log("[WignerMoyal4d] Step: %lu, Elapsed time: %lf sec\n", tt + 1, t_0_elapsed);
