...
void KleinKramers4d::Evolve()
{
    ...
    log->log("[KleinKramers4d] Fine grid size = (");
    ...
    for (unsigned long int tt = 0; tt < (unsigned long int)(TIME / kk); tt ++)
    {
        ...
        if ( true )
        {
            ...
            #pragma omp parallel
            {
                ...
                #pragma omp for private(xx1,xx2,xx3,xx4,f0,f1p,f1m,f2p,f2m,f3p,f3m,f4p,f4m)
                for (int i1 = 1; i1 < BoxShapeFine[0]-1; i1 ++)  {
                    for (int i2 = 1; i2 < BoxShapeFine[1]-1; i2 ++)  {
                        for (int i3 = 1; i3 < BoxShapeFine[2]-1; i3 ++)  {
                            for (int i4 = 1; i4 < BoxShapeFine[3]-1; i4 ++)  {
                ...
                // RK4-2
                #pragma omp for private(xx1,xx2,xx3,xx4,f0,f1p,f1m,f2p,f2m,f3p,f3m,f4p,f4m,kk0,kk1p,kk1m,kk2p,kk2m,kk3p,kk3m,kk4p,kk4m)
                for (int i1 = 1; i1 < BoxShapeFine[0]-1; i1 ++)  {
                    for (int i2 = 1; i2 < BoxShapeFine[1]-1; i2 ++)  {
                        for (int i3 = 1; i3 < BoxShapeFine[2]-1; i3 ++)  {
                            for (int i4 = 1; i4 < BoxShapeFine[3]-1; i4 ++)  {
